...
BATCH_SIZE     = 32        # batch 减半，避免 10M 模型 + 256 上下文时显存不够
BLOCK_SIZE     = 256       # BPE token 更“密实”，上下文窗口加倍
...
def main():
    ...
    # 3) 建模型
    # ---- 约 12M 参数的配置 ----
    # 注意：BPE 词表 50257 使得 token 嵌入 = 50257 * 192 ≈ 9.65M，占大头
    #         transformer block 本身只有 ~2.7M
    #         主体仍是“10M 数量级”的模型
    cfg = GPTConfig(
