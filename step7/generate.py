...
用法：
    python generate.py --message "What is the best way to learn Python?"
"""
import argparse
import os
import torch
...
from data  import get_encoder, EOS_ID
...
def main():
    ...
    prompt = HH_TEMPLATE.format(msg=args.message)
    print("=" * 60)
